...
var ha = ({ config: e2, onChange: r2, exchangeKeys: i2, onKeysChange: o2, disabled: s2, fundingRates: a2 = [], liveBalance: l2 }) => {
  ...
  return import_jsx_runtime.jsxs("div", { style: { padding: 16 }, children: [import_jsx_runtime.jsxs("div", { style: { padding: "8px 0", marginBottom: 8, fontSize: 11, color: "var(--fra-muted, #9ca3af)", display: "flex", alignItems: "center", gap: 6 }, children: [import_jsx_runtime.jsx("span", { style: { color: "#10b981", fontWeight: 700 }, children: "✓" }), e2.yieldMode === "compound" ? "Yield auto-compounds into position size" : "Yield sweep to spot is automatic on position close"] }), import_jsx_runtime.jsx(Js, { label: "Dry Run", checked: e2.dryRun, onChange: (e3) => r2({ dryRun: e3 }), disabled: s2, tooltip: "When enabled, the engine simulates all trades without placing real orders on the exchange. Useful for testing strategies, verifying configuration, and observing how the engine behaves before risking real capital. All P&L shown will be simulated.", tooltipPosition: "right" }), e2.dryRun && import_jsx_runtime.jsxs("div", { style: { padding: "10px 12px", marginBottom: 12, borderRadius: 8, backgroundColor: "var(--fra-card, #1f2937)", border: "1px solid var(--fra-border, #374151)" }, children: [import_jsx_runtime.jsx("div", { style: { fontSize: 11, fontWeight: 600, color: "var(--fra-muted, #9ca3af)", marginBottom: 8, textTransform: "uppercase", letterSpacing: 0.5 }, children: "Simulation Settings" }), import_jsx_runtime.jsx(Ys, { label: "Dry-Run Position Size", value: e2.positionSizeUsd, min: 1000, max: 1e5, step: 1000, formatValue: (e3) => ra(e3), onChange: (e3) => r2({ positionSizeUsd: e3 }), disabled: s2, tooltip: "The simulated USD notional value for each dry-run position. This also determines the simulated spot balance the engine uses to calculate paper P&L and funding accrual.", tooltipPosition: "right" }), import_jsx_runtime.jsx(Ys, { label: "Dry-Run Daily Loss", value: e2.maxDailyLossUsd, min: 500, max: 50000, step: 500, formatValue: (e3) => ra(e3), onChange: (e3) => r2({ maxDailyLossUsd: e3 }), disabled: s2, tooltip: "Informational daily capital budget for the simulation. Used for paper-trading bookkeeping only — no circuit-breaker logic is applied since the delta-neutral structure is inherently market-neutral." })] }), !e2.dryRun && import_jsx_runtime.jsx(ca, { title: import_jsx_runtime.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 6 }, children: ["Position Sizing", import_jsx_runtime.jsx(Vs, { text: "Controls how much capital the engine deploys per trade and in total. Larger positions earn more funding but carry higher liquidation risk.", children: import_jsx_runtime.jsx(qs, {}) })] }), children: import_jsx_runtime.jsx(Ys, { label: "Position Size", value: e2.positionSizeUsd, min: 1000, max: 1e5, step: 1000, formatValue: (e3) => ra(e3), onChange: (e3) => r2({ positionSizeUsd: e3 }), disabled: s2 || e2.useCapitalAllocation, tooltip: e2.useCapitalAllocation ? "Disabled — per-asset allocations override this global value. Adjust individual asset sliders in the Trading Pairs section." : "The USD notional value of each individual arbitrage position (one spot leg + one perp leg). A $10,000 position means ~$10k long spot and ~$10k short perp opened simultaneously." }) }), import_jsx_runtime.jsxs(ca, { title: import_jsx_runtime.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 6 }, children: ["Engine Settings", import_jsx_runtime.jsx(Vs, { text: "Scan frequency, exchange selection, execution mode, and API keys.", children: import_jsx_runtime.jsx(qs, {}) })] }), children: [import_jsx_runtime.jsx(Ys, { label: "Scan Interval", value: e2.scanIntervalSecs, min: 10, max: 300, step: 5, formatValue: (e3) => e3 >= 60 ? `${(e3 / 60).toFixed(e3 % 60 == 0 ? 0 : 1)}m` : `${e3}s`, onChange: (e3) => r2({ scanIntervalSecs: e3 }), disabled: s2, tooltip: "How often the engine fetches funding rates, updates P&L, and evaluates entry/exit conditions. Range: 10 seconds to 5 minutes. Shorter intervals react faster to funding rate changes but generate more API calls. The default 60s is a good balance between responsiveness and rate-limit safety.", tooltipPosition: "right" }), import_jsx_runtime.jsxs("div", { style: { marginTop: 4, marginBottom: 12 }, children: [import_jsx_runtime.jsxs("div", { style: { fontSize: 11, fontWeight: 600, color: "var(--fra-muted, #9ca3af)", marginBottom: 6, display: "flex", alignItems: "center", gap: 6 }, children: ["Discord Notifications", import_jsx_runtime.jsx(Vs, { text: "Paste a Discord webhook URL to receive real-time notifications for position opens, closes, margin warnings, and daily P&L summaries. Create a webhook in your Discord channel settings → Integrations → Webhooks.", children: import_jsx_runtime.jsx(qs, {}) }), e2.discordWebhookUrl && import_jsx_runtime.jsx("span", { style: { width: 7, height: 7, borderRadius: "50%", backgroundColor: "#10b981", display: "inline-block" } })] }), import_jsx_runtime.jsxs("div", { style: { display: "flex", gap: 6, alignItems: "center" }, children: [import_jsx_runtime.jsx("input", { type: "url", placeholder: "https://discord.com/api/webhooks/...", value: e2.discordWebhookUrl ?? "", onChange: (e3) => r2({ discordWebhookUrl: e3.target.value || undefined }), disabled: s2, style: { flex: 1, padding: "6px 10px", borderRadius: 6, border: "1px solid var(--fra-border, #374151)", backgroundColor: "var(--fra-card, #1f2937)", color: "var(--fra-text, #d1d5db)", fontSize: 12, fontFamily: "monospace", outline: "none" } }), import_jsx_runtime.jsx("button", { type: "button", disabled: s2 || !e2.discordWebhookUrl, onClick: async () => {
    ...
    })(i3), disabled: s2, tooltip: da[i3] || `Enable ${i3} for funding rate arbitrage scanning.`, tooltipPosition: "right" }) }), import_jsx_runtime.jsx("span", { style: { fontSize: 11, fontWeight: 600, fontFamily: "monospace", color: l3, minWidth: 64, textAlign: "right", paddingRight: 4 }, children: a3 !== null ? `${a3 >= 0 ? "+" : ""}${a3.toFixed(4)}%` : "—" })] }), e2.useCapitalAllocation && d3 && import_jsx_runtime.jsx("div", { style: { paddingLeft: 28, paddingRight: 4, marginTop: -2 }, children: import_jsx_runtime.jsx(Ys, { label: "", value: u3, min: 0, max: p3, step: 500, formatValue: (e3) => ra(e3), onChange: (e3) => ((e4, t2) => {
...
var Ka = ({ headerSlot: r2, exchangeKeys: c2, onExecution: d2, onError: u2, theme: h2 = "dark", defaultConfig: p2, persistenceStore: f2 }) => {
  const [g2, y2] = import_react.useState(() => Ws().theme ?? h2), [m2, b2] = import_react.useState(() => c2 && Object.keys(c2).length > 0 ? c2 : function() {
    try {
  ...
  }()), [w2, v2] = import_react.useState([]), [x2, P2] = import_react.useState("dashboard"), E2 = function(e2 = 640) {
  ...
  }(), [k2, I2] = import_react.useState([]), C2 = import_react.useRef(0), A2 = import_react.useRef(null), T2 = import_react.useCallback((e2) => {
    const t2 = ++C2.current;
    I2((n2) => [...n2, { ...e2, id: t2 }]), setTimeout(() => I2((e3) => e3.filter((e4) => e4.id !== t2)), 5000);
  }, []), R2 = import_react.useCallback((e2) => {
    if (d2?.(e2), v2((t2) => {
      const n2 = [...t2, e2];
    ...
    }(A2.current?.discordWebhookUrl, e2), e2.type === "position_closed") {
      ...
      if (n2 === "funding_flip" || n2 === "max_hold") {
        ...
        T2({ pair: e3, reason: n2, pnl: r3 });
      }
    }
  }, [d2, T2]), U2 = c2 && Object.keys(c2).length > 0 ? c2 : m2, { config: F2, state: O2, pnlHistory: z2, zScoreWarmup: N2, updateConfig: $2, start: B2, stop: L2, closeAllPositions: D2, adapter: _2, running: M2 } = Ks(U2, p2, R2, u2, f2), W2 = import_react.useMemo(() => [...F2.pairs], [F2.pairs]), { rates: H2, wsConnected: j2 } = Gs(_2, W2, true, F2.targetExchange), K2 = import_react.useMemo(() => O2.fundingRates.length > 0 ? O2.fundingRates : H2, [H2, O2.fundingRates]);
  import_react.useEffect(() => {
    A2.current = F2;
  }, [F2]), import_react.useEffect(() => {
    if (!F2.discordWebhookUrl || !M2)
      return;
    const e2 = setInterval(() => {
      const e3 = A2.current?.discordWebhookUrl;
      ...
      }(e3, O2, F2.targetExchange);
    }, 86400000);
    return () => clearInterval(e2);
  }, [F2.discordWebhookUrl, M2, F2.targetExchange, O2]);
  const [G2, V2] = import_react.useState(false), [q2, Y2] = import_react.useState(false), [J2, Z2] = import_react.useState([]), [X2, Q2] = import_react.useState(null), [ee2, te2] = import_react.useState(null), ne2 = g2 === "dark" ? _a : Ma;
  import_react.useEffect(() => {
    if (F2.dryRun || !_2)
      return void te2(null);
    const e2 = F2.targetExchange === "hyperliquid" ? "USDC" : "USDT";
    let t2 = false;
    const n2 = async () => {
      try {
        const n3 = await _2.getSettlementBalance(e2);
        t2 || te2(n3);
      } catch {}
    };
    n2();
  ...
  }, [_2, F2.dryRun, F2.targetExchange]), import_react.useEffect(() => {
    if (F2.dryRun) {
      const e3 = O2.positions.filter((e4) => e4.status === "open");
      if (e3.length === 0)
        return void Z2([]);
      const t3 = e3.map((e4) => {
    ...
    const t2 = async () => {
      try {
        const t3 = await _2.getPositions();
        e2 || Z2(t3.filter((e3) => e3.instrument === "spot"));
      } catch {}
    };
    t2();
  ...
  }, [_2, F2.dryRun, F2.positionSizeUsd, O2.positions]);
  const re2 = import_react.useCallback(() => {
    F2.dryRun || Qs(U2, F2.targetExchange) ? B2() : T2({ pair: "", reason: "missing_keys", pnl: 0, type: "warning" });
  }, [F2.dryRun, F2.targetExchange, U2, B2, T2]);
  return import_jsx_runtime.jsxs("div", { style: { ...ne2, fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', backgroundColor: "var(--fra-bg)", color: "var(--fra-text)", borderRadius: 12, border: "1px solid var(--fra-border)", overflow: "hidden", minWidth: 320, position: "relative" }, children: [k2.length > 0 && import_jsx_runtime.jsx("div", { style: { position: "absolute", top: E2 ? 100 : 56, right: 12, zIndex: 9000, display: "flex", flexDirection: "column", gap: 6, pointerEvents: "none" }, children: k2.map((r3) => {
    const i2 = r3.type === "warning" || r3.reason === "missing_keys";
    return import_jsx_runtime.jsxs("div", { style: { pointerEvents: "auto", padding: "8px 14px", borderRadius: 8, border: "1px solid " + (i2 ? "#f59e0b" : "var(--fra-border)"), backgroundColor: "var(--fra-card)", boxShadow: "0 4px 16px rgba(0,0,0,0.3)", fontSize: 12, display: "flex", alignItems: "center", gap: 8, animation: "fra-toast-in 0.25s ease-out", maxWidth: 300 }, children: [import_jsx_runtime.jsx("span", { style: { fontSize: 14 }, children: i2 ? "\uD83D\uDD11" : "\uD83D\uDCC9" }), import_jsx_runtime.jsx("div", { children: import_jsx_runtime.jsxs(import_jsx_runtime.Fragment, i2 ? { children: [import_jsx_runtime.jsx("div", { style: { fontWeight: 700, color: "#f59e0b", fontSize: 11 }, children: "API Keys Required" }), import_jsx_runtime.jsxs("div", { style: { color: "var(--fra-muted)", fontSize: 10, marginTop: 1 }, children: ["Configure ", F2.targetExchange === "hyperliquid" ? "Hyperliquid" : "OKX", " API keys in Settings before starting live trading."] })] } : { children: [import_jsx_runtime.jsxs("div", { style: { fontWeight: 700, color: "var(--fra-heading)", fontSize: 11 }, children: [r3.pair, " Closed"] }), import_jsx_runtime.jsxs("div", { style: { color: "var(--fra-muted)", fontSize: 10, marginTop: 1 }, children: [r3.reason === "funding_flip" ? "yield rate flipped negative" : "Max hold time reached", " · ", import_jsx_runtime.jsx("span", { style: { color: r3.pnl >= 0 ? "#10b981" : "#ef4444", fontWeight: 600 }, children: oa(r3.pnl) })] })] }) }), import_jsx_runtime.jsx("button", { type: "button", onClick: () => I2((e2) => e2.filter((e3) => e3.id !== r3.id)), style: { marginLeft: "auto", background: "none", border: "none", color: "var(--fra-muted)", cursor: "pointer", fontSize: 14, padding: 2, lineHeight: 1 }, children: "×" })] }, r3.id);
  }) }), import_jsx_runtime.jsxs("div", { style: { padding: "14px 16px", borderBottom: "1px solid var(--fra-border)", display: "flex", flexDirection: E2 ? "column" : "row", alignItems: E2 ? "stretch" : "center", justifyContent: "space-between", gap: E2 ? 10 : 0 }, children: [import_jsx_runtime.jsxs("div", { children: [import_jsx_runtime.jsx("h2", { style: { fontSize: 16, fontWeight: 700, margin: 0, color: "var(--fra-heading)" }, children: "Deltamaths" }), import_jsx_runtime.jsxs("span", { style: { fontSize: 11, color: "var(--fra-muted)" }, children: ["Exchange · ", F2.targetExchange === "hyperliquid" ? "Hyperliquid" : "OKX"] })] }), import_jsx_runtime.jsxs("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }, children: [import_jsx_runtime.jsx("button", { type: "button", onClick: () => {
    y2((e2) => {
  ...
  }, title: `Switch to ${g2 === "dark" ? "light" : "dark"} mode`, style: { padding: 6, borderRadius: 6, border: "1px solid var(--fra-border)", backgroundColor: "transparent", color: "var(--fra-muted)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }, children: g2 === "dark" ? import_jsx_runtime.jsxs("svg", { width: 14, height: 14, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round", children: [import_jsx_runtime.jsx("circle", { cx: 12, cy: 12, r: 5 }), import_jsx_runtime.jsx("line", { x1: 12, y1: 1, x2: 12, y2: 3 }), import_jsx_runtime.jsx("line", { x1: 12, y1: 21, x2: 12, y2: 23 }), import_jsx_runtime.jsx("line", { x1: 4.22, y1: 4.22, x2: 5.64, y2: 5.64 }), import_jsx_runtime.jsx("line", { x1: 18.36, y1: 18.36, x2: 19.78, y2: 19.78 }), import_jsx_runtime.jsx("line", { x1: 1, y1: 12, x2: 3, y2: 12 }), import_jsx_runtime.jsx("line", { x1: 21, y1: 12, x2: 23, y2: 12 }), import_jsx_runtime.jsx("line", { x1: 4.22, y1: 19.78, x2: 5.64, y2: 18.36 }), import_jsx_runtime.jsx("line", { x1: 18.36, y1: 5.64, x2: 19.78, y2: 4.22 })] }) : import_jsx_runtime.jsx("svg", { width: 14, height: 14, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round", children: import_jsx_runtime.jsx("path", { d: "M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" }) }) }), import_jsx_runtime.jsx("button", { type: "button", onClick: M2 ? L2 : re2, title: M2 ? "Stop the engine — halts the scan loop and prevents new trades. Open positions remain until manually closed or the engine is restarted." : `Start the engine — begins the ${F2.scanIntervalSecs}s scan loop. The engine will fetch yield rates, evaluate opportunities against your config thresholds, and open delta-neutral positions (spot + perp) when criteria are met. In Dry Run mode, trades are simulated.`, style: { padding: 6, borderRadius: 6, border: "1px solid var(--fra-border)", backgroundColor: M2 ? "rgba(239,68,68,0.12)" : "rgba(16,185,129,0.12)", color: M2 ? "#ef4444" : "#10b981", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.2s" }, children: M2 ? import_jsx_runtime.jsxs("svg", { width: 14, height: 14, viewBox: "0 0 24 24", fill: "currentColor", stroke: "none", children: [import_jsx_runtime.jsx("rect", { x: 6, y: 5, width: 4, height: 14, rx: 1 }), import_jsx_runtime.jsx("rect", { x: 14, y: 5, width: 4, height: 14, rx: 1 })] }) : import_jsx_runtime.jsx("svg", { width: 14, height: 14, viewBox: "0 0 24 24", fill: "currentColor", stroke: "none", children: import_jsx_runtime.jsx("polygon", { points: "6,4 20,12 6,20" }) }) }), import_jsx_runtime.jsx("button", { type: "button", onClick: () => V2(true), style: { padding: 6, borderRadius: 6, border: "1px solid var(--fra-border)", backgroundColor: "transparent", color: "var(--fra-muted)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }, title: "Settings", children: import_jsx_runtime.jsx(Wa, { size: 16 }) }), import_jsx_runtime.jsxs("button", { type: "button", onClick: () => {
    F2.dryRun ? Y2(true) : $2({ dryRun: true });
  }, title: F2.dryRun ? "Paper mode — all trades are simulated. Click to switch to live trading." : "Live mode — real orders are placed on the exchange. Click to switch to paper trading.", style: { padding: "4px 10px", borderRadius: 20, border: "1.5px solid " + (F2.dryRun ? "#f59e0b" : "#ef4444"), backgroundColor: F2.dryRun ? "rgba(245,158,11,0.12)" : "rgba(239,68,68,0.12)", color: F2.dryRun ? "#f59e0b" : "#ef4444", fontSize: 11, fontWeight: 700, cursor: "pointer", letterSpacing: 0.5, textTransform: "uppercase", display: "flex", alignItems: "center", gap: 5, transition: "all 0.2s", marginLeft: E2 ? 0 : "auto" }, children: [import_jsx_runtime.jsx("span", { style: { width: 6, height: 6, borderRadius: "50%", backgroundColor: F2.dryRun ? "#f59e0b" : "#ef4444", display: "inline-block", boxShadow: "0 0 4px " + (F2.dryRun ? "#f59e0b" : "#ef4444") } }), F2.dryRun ? "Paper" : "Live"] })] }), r2 && import_jsx_runtime.jsx("div", { style: { borderBottom: "1px solid var(--fra-border)" }, children: r2 })] }), q2 && import_jsx_runtime.jsxs("div", { style: { position: "fixed", inset: 0, zIndex: 1e4, display: "flex", alignItems: "center", justifyContent: "center" }, children: [import_jsx_runtime.jsx("div", { style: { position: "absolute", inset: 0, backgroundColor: "rgba(0,0,0,0.7)", backdropFilter: "blur(4px)" }, onClick: () => Y2(false) }), import_jsx_runtime.jsxs("div", { style: { ...ne2, position: "relative", width: "90%", maxWidth: 380, backgroundColor: "var(--fra-bg)", border: "1px solid var(--fra-border)", borderRadius: 12, padding: 24, boxShadow: "0 20px 60px rgba(0,0,0,0.5)" }, children: [import_jsx_runtime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }, children: [import_jsx_runtime.jsx("span", { style: { fontSize: 20 }, children: "⚠️" }), import_jsx_runtime.jsx("h3", { style: { fontSize: 15, fontWeight: 700, margin: 0, color: "var(--fra-heading)" }, children: "Switch to Live Trading?" })] }), import_jsx_runtime.jsxs("p", { style: { fontSize: 13, lineHeight: 1.5, color: "var(--fra-text)", marginBottom: 8 }, children: ["This will place ", import_jsx_runtime.jsx("strong", { style: { color: "#ef4444" }, children: "real orders" }), " on ", F2.targetExchange === "hyperliquid" ? "Hyperliquid" : "OKX", " using your API keys. Real capital will be deployed."] }), import_jsx_runtime.jsxs("ul", { style: { fontSize: 12, color: "var(--fra-muted)", margin: "0 0 12px 16px", padding: 0, lineHeight: 1.6 }, children: [import_jsx_runtime.jsx("li", { children: "Spot buy + Perp short orders will execute on-chain" }), import_jsx_runtime.jsx("li", { children: "Margin health monitor tracks position safety" }), import_jsx_runtime.jsx("li", { children: "Positions exit only when funding flips AND max hold time expires" })] }), import_jsx_runtime.jsxs("p", { style: { fontSize: 12, margin: "0 0 16px", color: Qs(U2, F2.targetExchange) ? "#10b981" : "#ef4444", display: "flex", alignItems: "center", gap: 6 }, children: [import_jsx_runtime.jsx("span", { children: Qs(U2, F2.targetExchange) ? "✓" : "✗" }), Qs(U2, F2.targetExchange) ? (F2.targetExchange === "hyperliquid" ? "Hyperliquid" : "OKX") + " API keys are configured." : `No API keys for ${F2.targetExchange === "hyperliquid" ? "Hyperliquid" : "OKX"}. Configure keys in Settings before going live.`] }), import_jsx_runtime.jsxs("div", { style: { display: "flex", gap: 8, justifyContent: "flex-end" }, children: [import_jsx_runtime.jsx("button", { type: "button", onClick: () => Y2(false), style: { padding: "8px 16px", borderRadius: 6, border: "1px solid var(--fra-border)", backgroundColor: "transparent", color: "var(--fra-text)", fontSize: 13, fontWeight: 600, cursor: "pointer" }, children: "Cancel" }), import_jsx_runtime.jsx("button", { type: "button", onClick: () => {
    if (!Qs(U2, F2.targetExchange))
      return Y2(false), void T2({ pair: "", reason: "missing_keys", pnl: 0, type: "warning" });
    $2({ dryRun: false }), Y2(false);
  }, style: { padding: "8px 16px", borderRadius: 6, border: "none", backgroundColor: "#ef4444", color: "#fff", fontSize: 13, fontWeight: 700, cursor: "pointer" }, children: "Go Live" })] })] })] }), import_jsx_runtime.jsxs("div", E2 ? { style: { display: "flex", flexDirection: "column", height: "calc(100vh - 80px)", minHeight: 360 }, children: [import_jsx_runtime.jsx("div", { style: { flex: 1, overflowY: "auto", minHeight: 0 }, children: import_jsx_runtime.jsxs("div", x2 === "dashboard" ? { style: { display: "flex", flexDirection: "column" }, children: [import_jsx_runtime.jsx(ba, { state: O2, wsConnected: j2, spotBalances: J2, maxSlippagePct: F2.maxSlippagePct, targetExchange: F2.targetExchange, dryRun: F2.dryRun, positionSizeUsd: F2.positionSizeUsd, settlementBalance: ee2, zScoreWarmup: N2 }), import_jsx_runtime.jsx(Oa, { positions: O2.positions, fundingRates: K2, spotBalances: J2, maxSlippagePct: F2.maxSlippagePct, isDryRun: F2.dryRun, onCloseAll: D2 }), import_jsx_runtime.jsx("div", { style: { flexShrink: 0, padding: "0 16px 16px", borderTop: "1px solid var(--fra-border)", maxHeight: 280, overflow: "auto" }, children: import_jsx_runtime.jsx("div", { style: { paddingTop: 12 }, children: import_jsx_runtime.jsx(Da, { events: w2 }) }) })] } : { style: { padding: "12px 16px", display: "flex", flexDirection: "column" }, children: [import_jsx_runtime.jsx("h4", { style: { fontSize: 13, fontWeight: 600, marginBottom: 8, color: "var(--fra-heading)" }, children: "P&L History" }), import_jsx_runtime.jsx("div", { style: { flex: 1, minHeight: 180 }, children: import_jsx_runtime.jsx(ka, { snapshots: z2, height: 300 }) }), import_jsx_runtime.jsx(Ra, { fundingRates: K2, positions: O2.positions, layout: "grid" })] }) }), import_jsx_runtime.jsx("div", { style: { display: "flex", borderTop: "1px solid var(--fra-border)", backgroundColor: "var(--fra-bg)", flexShrink: 0 }, children: ["dashboard", "chart"].map((e2) => import_jsx_runtime.jsx("button", { type: "button", onClick: () => P2(e2), style: { flex: 1, padding: "10px 0", border: "none", borderTop: x2 === e2 ? "2px solid var(--fra-accent)" : "2px solid transparent", backgroundColor: "transparent", color: x2 === e2 ? "var(--fra-heading)" : "var(--fra-muted)", fontSize: 12, fontWeight: 600, cursor: "pointer", transition: "all 0.15s" }, children: e2 === "dashboard" ? "\uD83D\uDCCA Dashboard" : "\uD83D\uDCC8 P&L History" }, e2)) })] } : { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gridTemplateRows: "auto 1fr", minHeight: 360 }, children: [import_jsx_runtime.jsxs("div", { style: { borderRight: "1px solid var(--fra-border)", display: "flex", flexDirection: "column", overflow: "hidden", gridRow: "1 / -1" }, children: [import_jsx_runtime.jsx("div", { style: { flexShrink: 0 }, children: import_jsx_runtime.jsx(ba, { state: O2, wsConnected: j2, spotBalances: J2, maxSlippagePct: F2.maxSlippagePct, targetExchange: F2.targetExchange, dryRun: F2.dryRun, positionSizeUsd: F2.positionSizeUsd, settlementBalance: ee2, zScoreWarmup: N2 }) }), import_jsx_runtime.jsx("div", { style: { flex: "0 0 auto", padding: "0 16px", marginTop: 12 }, children: import_jsx_runtime.jsx(Da, { events: w2 }) })] }), import_jsx_runtime.jsxs("div", { style: { padding: "12px 16px", overflowY: "auto", display: "flex", flexDirection: "column", gridRow: "1 / -1", maxHeight: 600 }, children: [import_jsx_runtime.jsx("h4", { style: { fontSize: 13, fontWeight: 600, marginBottom: 8, color: "var(--fra-heading)" }, children: "P&L History" }), import_jsx_runtime.jsxs("div", { style: { display: "flex", gap: 8, minHeight: 180 }, children: [import_jsx_runtime.jsx("div", { style: { flex: 1, minWidth: 0 }, children: import_jsx_runtime.jsx(ka, { snapshots: z2, height: 240 }) }), import_jsx_runtime.jsx("div", { style: { width: 160, flexShrink: 0, overflowY: "auto", maxHeight: 240 }, children: import_jsx_runtime.jsx(Ra, { fundingRates: K2, positions: O2.positions, layout: "vertical", showTitle: true }) })] }), import_jsx_runtime.jsx("div", { style: { marginTop: 12 } }), import_jsx_runtime.jsx(Oa, { positions: O2.positions, fundingRates: K2, spotBalances: J2, maxSlippagePct: F2.maxSlippagePct, isDryRun: F2.dryRun, onCloseAll: D2 })] })] }), G2 && import_jsx_runtime.jsxs("div", { style: { position: "fixed", inset: 0, zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center" }, children: [import_jsx_runtime.jsx("div", { style: { position: "absolute", inset: 0, backgroundColor: "rgba(0,0,0,0.6)", backdropFilter: "blur(4px)" }, onClick: () => V2(false) }), import_jsx_runtime.jsxs("div", { style: { ...ne2, position: "relative", width: "90%", maxWidth: 440, maxHeight: "80vh", backgroundColor: "var(--fra-bg)", border: "1px solid var(--fra-border)", borderRadius: 12, overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.5)", display: "flex", flexDirection: "column" }, children: [import_jsx_runtime.jsxs("div", { style: { padding: "14px 16px", borderBottom: "1px solid var(--fra-border)", display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [import_jsx_runtime.jsx("h3", { style: { fontSize: 15, fontWeight: 700, margin: 0, color: "var(--fra-heading)" }, children: "Configuration" }), import_jsx_runtime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [import_jsx_runtime.jsx("button", { type: "button", onClick: () => {
    window.confirm("Reset all settings to defaults?") && (Hs(S), $2(S), Q2("Settings reset to defaults"));
  }, style: { padding: 4, borderRadius: 6, border: "none", backgroundColor: "transparent", color: "var(--fra-muted)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }, title: "Reset to defaults", children: import_jsx_runtime.jsx(ja, { size: 16 }) }), import_jsx_runtime.jsx("button", { type: "button", onClick: () => V2(false), style: { padding: 4, borderRadius: 6, border: "none", backgroundColor: "transparent", color: "var(--fra-muted)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }, title: "Close", children: import_jsx_runtime.jsx(Ha, { size: 18 }) })] })] }), import_jsx_runtime.jsx("div", { style: { overflowY: "auto", flex: 1 }, children: import_jsx_runtime.jsx(ha, { config: F2, onChange: $2, exchangeKeys: m2, onKeysChange: b2, fundingRates: H2, liveBalance: ee2 }) })] })] }), X2 && import_jsx_runtime.jsxs("div", { style: { position: "fixed", bottom: 24, left: "50%", transform: "translateX(-50%)", padding: "10px 20px", borderRadius: 8, backgroundColor: "var(--fra-card, #1f2937)", border: "1px solid var(--fra-border, #374151)", color: "var(--fra-heading, #f9fafb)", fontSize: 13, fontWeight: 600, boxShadow: "0 8px 24px rgba(0,0,0,0.4)", zIndex: 9999, animation: "fra-toast-in 0.25s ease-out" }, ref: (e2) => {
    if (e2) {
      const t2 = setTimeout(() => Q2(null), 2500);
